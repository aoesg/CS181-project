...
if __name__ == '__main__':
    ...
    ag_fast_learning = agent.Agent_fast_learning()
    ...
    agent_test.train_in_normalFieldTest(ag_fast_learning)
    print("ag_fast_learning,avg=", agent_test.normalFieldTest_avg(num_game, ag_fast_learning))
    print(ag_fast_learning.weights)